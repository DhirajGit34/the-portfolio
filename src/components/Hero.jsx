        ...
        <div className="md:flex items-center justify-between">
          <div className="md:w-1/2 space-y-6 reveal-on-scroll opacity-0 translate-y-10 transition-all duration-1000 ease-out">
            ...
            <div className="flex items-center justify-center md:justify-start gap-6 pt-8 text-slate-500 dark:text-slate-400">
              <a href="https://github.com/DhirajGit34" target='_blank' className="hover:text-teal-500 dark:hover:text-teal-400 transition-colors transform hover:scale-110"><Github size={24} /></a>
              <a href="https://tinyurl.com/y3nndvz3" target='_blank' className="hover:text-teal-500 dark:hover:text-teal-400 transition-colors transform hover:scale-110"><Linkedin size={24} /></a>
              <a href="mailto:dhirajdeka36@gmail.com" target='_blank' className="hover:text-teal-500 dark:hover:text-teal-400 transition-colors transform hover:scale-110"><Mail size={24} /></a>
            </div>
          </div>
